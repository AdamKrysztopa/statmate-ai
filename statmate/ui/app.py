...
from statmate.ui.components.credentials import (  # noqa: E402
        ...
        try:
            ...
            if status["status"] == "running":
                ...
                try:
                    ...
                    workflow_graph = (
                        results.get("workflow_graph")
                        or (results.get("results_detail") or {}).get("workflow_graph")
                        or {}
                    )
                    ...
                    effect_sizes = results.get("effect_sizes") or (results.get("results_detail") or {}).get(
                        "effect_sizes"
                    )
